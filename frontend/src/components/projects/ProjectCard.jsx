...
const ownerName = `${project.owner_first_name || ""} ${project.owner_last_name || ""}`.trim() || "Brak danych";
            ...
            <div className="d-flex justify-content-between align-items-start gap-3 mb-3">
                ...
                <Badge bg="light" text="dark" className="border">
                    ...
                    <Stack direction="horizontal" gap={2} className="mt-auto">
                      ...
                      <Button variant={isMembersOpen ? "dark" : "outline-dark"} onClick={() => onOpenMembers(project)}>
